...
void read_input(SPARC_INPUT_OBJ *pSPARC_Input, SPARC_OBJ *pSPARC) {
    ...
    while (!feof(input_fp)) {
        ...
        if (strcmpi(str,"NP_SPIN_PARAL:") == 0) {
            ...
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"Vxc_flag_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->Vxc_flag_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"INVERSE_FLAG:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->INVERSE_FLAG);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"VTF_flag_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->VTF_flag_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"print_Vp_flag_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->print_Vp_flag_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"read_Vp_guess_flag_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->read_Vp_guess_flag_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"BFGS_MAXITER_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->BFGS_MAXITER_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"BFGS_history_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->BFGS_history_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"MAXITER_KRYLOV_SCHUR_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->MAXITER_KRYLOV_SCHUR_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"MAXITER_CG_inverse:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->MAXITER_CG_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"TOL_CG_inverse:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->TOL_CG_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"BFGS_TOL_inverse:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->BFGS_TOL_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"KRYLOV_SCHUR_TOL_inverse:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->KRYLOV_SCHUR_TOL_inverse);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"fname_Vp_guess:") == 0) {    
            fscanf(input_fp,"%s",pSPARC_Input->fname_Vp_guess);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"fname_rho_data:") == 0) {    
            fscanf(input_fp,"%s",pSPARC_Input->fname_rho_data);
            fscanf(input_fp, "%*[^\n]\n");
        }
           ...
           fscanf(input_fp, "%*[^\n]\n");
            ...
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_FLAG:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->DDBP_Flag);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_NALB_ATOM:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->DDBP_nALB_atom);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_NELEMS:") == 0) {
            fscanf(input_fp,"%d", &pSPARC_Input->DDBP_Nex);
            fscanf(input_fp,"%d", &pSPARC_Input->DDBP_Ney);
            fscanf(input_fp,"%d", &pSPARC_Input->DDBP_Nez);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_NPELEM:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->DDBP_npelem);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_NPBASIS:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->DDBP_npbasis);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_BUFFERS:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->DDBP_buffer_x);
            fscanf(input_fp,"%lf", &pSPARC_Input->DDBP_buffer_y);
            fscanf(input_fp,"%lf", &pSPARC_Input->DDBP_buffer_z);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_TOL_UPDATEBASIS:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->DDBP_tol_updatebasis);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_TOL_UPDATEBASIS_FIRST_EGS:") == 0) {
            fscanf(input_fp,"%lf", &pSPARC_Input->DDBP_tol_updatebasis_first_EGS);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"DDBP_EBC:") == 0) { 
            // read BC in 1st lattice direction
            fscanf(input_fp,"%s",temp);
            if (strcmpi(temp,"p") == 0) {
                pSPARC_Input->DDBP_EBCx = 0;
            } else if (strcmpi(temp,"d") == 0) {
                pSPARC_Input->DDBP_EBCx = 1;
            } else {
                printf("Cannot recognize boundary condition: %s\n", temp);
                exit(EXIT_FAILURE);
            }
            ...
            fscanf(input_fp,"%s",temp);
            if (strcmpi(temp,"p") == 0) {
                pSPARC_Input->DDBP_EBCy = 0;
            } else if (strcmpi(temp,"d") == 0) {
                pSPARC_Input->DDBP_EBCy = 1;
            } else {
                printf("Cannot recognize boundary condition: %s\n", temp);
                exit(EXIT_FAILURE);
            }
            ...
            fscanf(input_fp,"%s",temp);
            if (strcmpi(temp,"p") == 0) {
                pSPARC_Input->DDBP_EBCz = 0;
            } else if (strcmpi(temp,"d") == 0) {
                pSPARC_Input->DDBP_EBCz = 1;
            } else {
                printf("Cannot recognize boundary condition: %s\n", temp);
                exit(EXIT_FAILURE);
            }
            snprintf(str, L_STRING, "undefined");    // initialize str
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"CS_FLAG:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->CS_Flag);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"CS_NSTATES_TOP:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->CS_Nt);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"CS_CHEBDEGREE:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->CS_npl);
            fscanf(input_fp, "%*[^\n]\n");
        } else if (strcmpi(str,"CS_NCHEB:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->CS_ncheb);
            fscanf(input_fp, "%*[^\n]\n");
        ...
        /* OFDFT input options */
            ...
            fscanf(input_fp,"%d",&pSPARC_Input->PrintEnergyDensFlag);
            fscanf(input_fp, "%*[^\n]\n");
        } else if(strcmpi(str,"EXT_FPMD_FLAG:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->ext_FPMD_Flag);
            fscanf(input_fp, "%*[^\n]\n");
        } else if(strcmpi(str,"EXT_FPMD_NSCUT:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->ext_FPMD_nscut);
            fscanf(input_fp, "%*[^\n]\n");
        } else if(strcmpi(str,"NONLOCAL_FLAG:") == 0) {
            fscanf(input_fp,"%d",&pSPARC_Input->nonlocal_flag);
            fscanf(input_fp, "%*[^\n]\n");
        } else {
        ...
        for (l = 0; l <= pSPARC->psd[ityp].lmax; l++) {
            if (l != pSPARC->localPsd[ityp]) {
                for (kk = 0; kk < pSPARC->psd[ityp].ppl[l]; kk++) {
                    ...
                    // for debugging purpose, overwrite gamma by 0 to turn off the nonlocal projector term
                    if (pSPARC_Input->nonlocal_flag == 0) {
                        pSPARC->psd[ityp].Gamma[lpos[l]+kk] = 0.0;
                    }
                }
            ...
            for (l = 1; l <= pSPARC->psd[ityp].lmax; l++) {
                ...
                if (l != pSPARC->localPsd[ityp]) {
                    for (kk = 0; kk < pSPARC->psd[ityp].ppl_soc[l-1]; kk++) {
                        ...
                        if (pSPARC_Input->nonlocal_flag == 0) {
                            // for debugging purpose, overwrite gamma_soc by 0 to turn off the nonlocal projector term
                            pSPARC->psd[ityp].Gamma_soc[lpos_soc[l-1]+kk] = 0.0;
                        }
                    }
                    for (jj = 0; jj < pSPARC->psd[ityp].size; jj++) {
                        fscanf(psd_fp,"%lf", &vtemp);
