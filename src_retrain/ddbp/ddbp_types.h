...
struct _DDBP_INFO {
    ...
    MPI_Comm rowcomm; // similar to elemcomm, except it only includes active basiscomm's (basiscomm_index>=0)
    int is_active_rowcomm; // flag indicating whether rowcomm is active (equiv. to basiscomm_index >= 0)
