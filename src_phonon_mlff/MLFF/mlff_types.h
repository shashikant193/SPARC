...
typedef struct NeighList
{
  ...
  int *if_self_image;
  // if the neighbor list of an atom contains it's self image
...
typedef struct SoapObj
{
  ...
  // array of 2-body descriptor SOAP, X2[q][natom][size_X3]
  double complex ***X3_q;
  // array of 2-body descriptor derivatives for x-dir force, dX2_dY[q][natom][1+neigh][size_X2]
  double complex *****dX3_q;
  // array of 3-body descriptor derivatives for y-dir force, dX3_dY[q][natom][1+neigh][size_X3]
  double complex ******d2X3_q; //d2X3[q][na][1+neigh][1+neigh][size_X3][mm];
} SoapObj;
...
typedef struct MLFF_Obj
{
  ...
  double *relative_scale_stress;
  
  double *F_store;
  double *E_store;
  double **stress_store;
  // double *stress1_store;
  // double *stress2_store;
  // double *stress3_store;
  // double *stress4_store;
  // double *stress5_store;
