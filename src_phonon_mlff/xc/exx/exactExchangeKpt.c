        ...
        double _Complex *psi_outer, int ldpo, double _Complex *Hx, int ldhx, int kpt_k, MPI_Comm comm) 
{
    ...
    for (loop = 0; loop < NL; loop ++) {
        ...
        poissonSolve_kpt(pSPARC, rhs, pSPARC->pois_const, count-base, DMnd, dims, Vi, kpt_k_list, kpt_q_list, comm);
                ...
                int *dims, double _Complex *Vi, int *kpt_k_list, int *kpt_q_list, MPI_Comm comm) 
{
    ...
    pois_fft_kpt(pSPARC, rhs_loc_order, pois_const, ncolp, Vi_loc, kpt_k_list + kq_shift, kpt_q_list + kq_shift);
 ...
 */
void pois_fft_kpt(SPARC_OBJ *pSPARC, double _Complex *rhs_loc_order, double *pois_const, 
    ...
    int ncol, double _Complex *psi, int ldp, double _Complex *psi_storage, int ldps, double *occ, double _Complex *Xi_kpt, int ldxi, int kpt_q, int shift)
{
    ...
    for (loop = 0; loop < NL; loop ++) {
        ...
        poissonSolve_kpt(pSPARC, rhs, pSPARC->pois_const, count-base, DMnd, dims, Vi, kpt_k_list, kpt_q_list, pSPARC->dmcomm);    
