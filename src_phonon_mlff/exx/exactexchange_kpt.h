...
#ifndef EXACTEXCHANGE_KPT_H
#define EXACTEXCHANGE_KPT_H
 ...
 */
void pois_fft_kpt(SPARC_OBJ *pSPARC, double _Complex *rhs_loc_order, int ncolp, double _Complex *Vi_loc, int *kpt_k_list, int *kpt_q_list);
